class Title:
    ...
    @staticmethod
    def effect_title(app1):

        node = app1.getNode("Title")
        ...
        Title.set_color(color_param, 1, (0.6631, 0.6631, 0.6631, 1.0))
        Title.set_color(color_param, start_frame - 1, (0.6631, 0.6631, 0.6631, 1.0))
        ...
        Title.set_color(color_param, end_frame - 1, (0.6631, 0.6631, 0.6631, 1.0))
        Title.set_color(color_param, end_frame, (0.0, 1.0, 0.0159962922334671, 1.0))
        Title.set_color(color_param, 300, (0.0, 1.0, 0.0159962922334671, 1.0))